...
type Props = {
  ...
  setAuthRegister: React.Dispatch<React.SetStateAction<{ username: string; password: string }>>
}
  ...
  return (
    <section className='register-page'>
      <div className='register-info'>
        ...
        <p>Yangi foydalanuvchini 1 daqiqada qo‘shing va darhol tizimga kiriting.</p>
        <ul>
      ...
      <div className='register-card'>
        ...
        <form className='editor-form' onSubmit={e => void submitRegister(e)}>
          <input
            ...
            onChange={e => setAuthRegister(p => ({ ...p, username: e.target.value }))}
          />
          <input
            required
            type='password'
            ...
            onChange={e => setAuthRegister(p => ({ ...p, password: e.target.value }))}
          />
          <button type='submit'>Register</button>
        </form>
        <p className='switch-note'>Akkaunt bor bo‘lsa Login bo‘limidan kiring.</p>
      </div>
    </section>
  )
}
